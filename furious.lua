...
myappz["g"] = { info="chrome", cmd="chromium", tag="1", screen=2, match="Chrome", type="instance" }
...
myappz["t"] = { info="terminal", cmd="urxvt", tag="3", screen=2, match="terminal", type="instance" }
